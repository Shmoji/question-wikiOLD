...
exports.up = function(knex, Promise) {
    ...
    table.integer('question_id'); // Question that this edit is on (FK)
    // If question is deleted, so is this edit (maybe not eventualy)
...
exports.down = function(knex, Promise) {
	return knex.schema.dropTable('Edits');  // Get rid of Questions table
};